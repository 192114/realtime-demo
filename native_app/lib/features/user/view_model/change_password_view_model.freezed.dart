...
@override
String toString() {
  return 'ChangePasswordState(isLoading: $isLoading, successMessage: $successMessage, errorMessage: $errorMessage)';
}
...
class _ChangePasswordState implements ChangePasswordState {
  const _ChangePasswordState({this.isLoading = false, this.successMessage, this.errorMessage});
