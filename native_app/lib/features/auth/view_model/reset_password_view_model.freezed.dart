...
@override
String toString() {
  return 'ResetPasswordState(isLoading: $isLoading, successMessage: $successMessage, errorMessage: $errorMessage)';
}
...
class _ResetPasswordState implements ResetPasswordState {
  const _ResetPasswordState({this.isLoading = false, this.successMessage, this.errorMessage});
